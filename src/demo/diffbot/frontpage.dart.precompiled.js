...
function dart_precompiled($collectedClasses) {
  ...
  function Symbol0(_dev$_name) {
    this._dev$_name = _dev$_name;
  }
  ...
  Symbol0.prototype.get$_dev$_name = function() {
    return this._dev$_name;
  };
  function Future() {
  }
  ...
  function Client_getFrontpage_closure(completer_0) {
    this.completer_0 = completer_0;
  }
  Client_getFrontpage_closure.builtin$cls = "Client_getFrontpage_closure";
  if (!"name" in Client_getFrontpage_closure)
    Client_getFrontpage_closure.name = "Client_getFrontpage_closure";
  $desc = $collectedClasses.Client_getFrontpage_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Client_getFrontpage_closure.prototype = $desc;
  function Frontpage(_data) {
    this._data = _data;
  }
  Frontpage.builtin$cls = "Frontpage";
  if (!"name" in Frontpage)
    Frontpage.name = "Frontpage";
  $desc = $collectedClasses.Frontpage;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Frontpage.prototype = $desc;
  function FpItem(_item) {
    this._item = _item;
  }
  FpItem.builtin$cls = "FpItem";
  if (!"name" in FpItem)
    FpItem.name = "FpItem";
  $desc = $collectedClasses.FpItem;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FpItem.prototype = $desc;
  function main_closure(title_0) {
