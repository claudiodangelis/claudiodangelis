...
"+_BufferingStreamSubscription": [31, 32, 33],
...
Object: {"": ";",
  ...
  get$media: function($receiver) {
    return this.noSuchMethod$1(this, H.createInvocationMirror("media", "get$media", 1, [], []));
  },
  "+media": 1,
  get$memberName: function() {
  ...
  "+next": 1,
  get$offerPrice: function() {
    return this.noSuchMethod$1(this, H.createInvocationMirror("offerPrice", "get$offerPrice", 1, [], []));
  },
  "+offerPrice": 1,
  ...
  get$products: function() {
    return this.noSuchMethod$1(this, H.createInvocationMirror("products", "get$products", 1, [], []));
  },
  "+products": 1,
  get$registerCallback: function() {
...
"+InputElement": [67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87],
...
LinkElement: {"": "HtmlElement;media=-,type%-"},
...
SourceElement: {"": "HtmlElement;media=-,src}-,type%-"},
...
StyleElement: {"": "HtmlElement;media=-,type%-"},
...
"+FEColorMatrixElement": [90],

FETurbulenceElement: {"": "SvgElement;type=-"},

"+FETurbulenceElement": [90],

ScriptElement0: {"": "SvgElement;type%-"},

"+ScriptElement": [91, 92],

StyleElement0: {"": "SvgElement;media=-,type%-",
  get$title: function(receiver) {
    return receiver.title;
  },
  "+title": 1
...
Client: {"": "BaseClient;token-,base_client$BaseClient$token-,articleEndpoint-,frontpageEndpoint-,productEndpoint-",
  getProduct$2$timeout: function(url, timeout) {
    var t1, completer, requestUrl, data, scriptTag, t2;
    t1 = null;
    completer = new P._AsyncCompleter(P._Future$(t1));
    H.setRuntimeTypeInfo(completer, [t1]);
    requestUrl = P.Uri__uriEncode(C.List_CVk, C.JSString_methods.$add(this.productEndpoint + "?token=" + this.token + "&url=", url) + "" + "&callback=handler", false);
    ...
    Q._enterScopeIfNeeded();
    J.$indexSet$ax(Q._deserialize($._jsPortSync.callSync$1([])), "handler", Q.Callback$once(new Q.Client_getProduct_closure(completer, data), false));
  ...
  "+getProduct:1:1:timeout": 1,
  "*getProduct": [0],
  getProduct$1: function(url) {
    return this.getProduct$2$timeout(url, null);
  },
  "+getProduct:1:0": 1
},
...
Client_getProduct_closure: {"": "Closure;completer_0-,data_1-",
  call$1: function(_data) {
    var t1, t2, i, t3, _prodMediaList, j, _prodMedia, _tmpProd;
    t1 = this.data_1;
    t2 = J.getInterceptor$asx(_data);
    t1.addAll$1(t1, H.fillLiteralMap(["type", t2.$index(_data, "type"), "url", t2.$index(_data, "url"), "resolved_url", t2.$index(_data, "resolved_url"), "breadcrumbs", t2.$index(_data, "breadcrumbs"), "products", []], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
    i = 0;
    while (true) {
      t3 = J.get$length$asx(t2.$index(_data, "products"));
      if (typeof t3 !== "number")
        throw H.iae(t3);
      if (!(i < t3))
        break;
      ...
      j = 0;
      while (true) {
        t3 = J.get$length$asx(J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "media"));
        if (typeof t3 !== "number")
          throw H.iae(t3);
        if (!(j < t3))
          break;
        _prodMedia = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        t3 = new S.JsObjectToMapAdapter(null, J.$index$asx(J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "media"), j));
        t3.$builtinTypeInfo = [null];
        P.Maps_forEach(t3, new Q.Client_getProduct__closure(_prodMedia));
        _prodMediaList.push(new S.ProductMedia(_prodMedia));
        ++j;
      }
      _tmpProd = H.fillLiteralMap(["title", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "title"), "description", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "description"), "brand", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "brand"), "offerPrice", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "offerPrice"), "regularPrice", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "regularPrice"), "saveAmount", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "saveAmount"), "shippingAmount", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "shippingAmount"), "productId", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "productId"), "upc", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "upc"), "prefixCode", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "prefixCode"), "productOrigin", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "productOrigin"), "isbn", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "isbn"), "sku", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "sku"), "mpn", J.$index$asx(J.$index$asx(t2.$index(_data, "products"), i), "mpn"), "media", _prodMediaList], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      J.add$1$ax(t1.$index(t1, "products"), new S.ProductItem(_tmpProd));
      ++i;
    }
    t2 = this.completer_0.future;
    if (t2._state !== 0)
      H.throwExpression(new P.StateError("Future already completed"));
    t2._asyncComplete$1(new S.Product(t1));
  },
  "+call:1:0": 1,
  $isFunction: true
},

"+Client_getProduct_closure": [],

Client_getProduct__closure: {"": "Closure;_prodMedia_2-",
  call$2: function(k, v) {
    var t1 = this._prodMedia_2;
...
"+TypedProxy": [59]}],
["product", "package:diffbot/src/shared/product.dart", , S, {
Product: {"": "Object;_data-",
  get$url: function(_) {
    var t1 = this._data;
...
ProductItem: {"": "Object;_data-",
  get$title: function(_) {
    var t1 = this._data;
    return t1.$index(t1, "title");
  },
  "+title": 1,
  get$media: function(_) {
    var t1 = this._data;
    return t1.$index(t1, "media");
  },
  "+media": 1,
  get$offerPrice: function() {
    var t1 = this._data;
    return t1.$index(t1, "offerPrice");
  },
  "+offerPrice": 1,
  toString$0: function(_) {
    var t1 = this._data;
...
"+ProductMedia": []}],
["product.dart", "product.dart", , T, {
main: function() {
  var client, try1, t1, t2, t3, try2;
  ...
  client.getProduct$1("http://www.amazon.com/Yamaha-S90XS-Synthesizer-Balanced-Hammer-Weighted/dp/B002NCW7G8").then$1(new T.main_closure());
  try1 = document.querySelector("#try1");
  try1.toString;
  t1 = C.EventStreamProvider_click._eventType;
  t2 = new W._ElementEventStreamImpl(try1, t1, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._EventStreamSubscription__wrapZone(new T.main_closure0(client, try1)), t2._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t3._tryResume$0();
  try2 = document.querySelector("#try2");
  try2.toString;
  t3 = new W._ElementEventStreamImpl(try2, t1, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t2 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._EventStreamSubscription__wrapZone(new T.main_closure1(client, try2)), t3._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = $.get$btn();
  t2.toString;
  ...
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._EventStreamSubscription__wrapZone(new T.main_closure2(client)), t1._useCapture);
...
displayResults: function(prod) {
  var t1 = J.get$children$x($.get$images());
  t1.clear$0(t1);
  J.set$src$x($.get$loading(), "");
  $.get$url().textContent = J.get$url$x(prod);
  $.get$title().textContent = J.get$title$x(J.$index$asx(prod.get$products(), 0));
  $.get$price().textContent = J.$index$asx(prod.get$products(), 0).get$offerPrice();
  J.forEach$1$ax(J.get$media$x(J.$index$asx(prod.get$products(), 0)), new T.displayResults_closure());
},

"+displayResults:1:0": 1,

main_closure: {"": "Closure;",
  call$1: function(prod) {
    T.displayResults(prod);
  },
  "+call:1:0": 1,
  $isFunction: true
},
...
main_closure0: {"": "Closure;client_0-,try1_1-",
  call$1: function(e) {
    J.set$src$x($.get$loading(), "ajax-loader.gif");
    this.client_0.getProduct$1(this.try1_1.textContent).then$1(new T.main__closure());
  },
  "+call:1:0": 1,
  $isFunction: true
},
...
main_closure1: {"": "Closure;client_2-,try2_3-",
  call$1: function(e) {
    J.set$src$x($.get$loading(), "ajax-loader.gif");
    this.client_2.getProduct$1(this.try2_3.textContent).then$1(new T.main__closure0());
  },
  "+call:1:0": 1,
  $isFunction: true
},
...
main_closure2: {"": "Closure;client_4-",
  call$1: function(e) {
    if (J.get$value$x($.get$input()) !== "") {
      J.set$src$x($.get$loading(), "ajax-loader.gif");
      this.client_4.getProduct$1(J.get$value$x($.get$input())).then$1(new T.main__closure1());
    }
  },
  "+call:1:0": 1,
  $isFunction: true
...
displayResults_closure: {"": "Closure;",
  call$1: function(prodMedia) {
    var t1, t2;
    if (J.$eq(J.get$type$x(prodMedia), "image")) {
      t1 = J.get$children$x($.get$images());
      t2 = W.ImageElement_ImageElement(null, null, null);
      J.set$src$x(t2, prodMedia.get$link());
      t1.add$1(t1, t2);
    }
  },
  "+call:1:0": 1,
...
S.Product.$isProduct = true;
S.Product.$isObject = true;
W.Event.$isEvent = true;
W.Event.$isObject = true;
S.ProductMedia.$isProductMedia = true;
S.ProductMedia.$isObject = true;
...
J.get$media$x = function(receiver) {
  return J.getInterceptor$x(receiver).get$media(receiver);
};
...
Isolate.$lazy($, "price", "price", "get$price", function() {
...
// Native classes
H.defineNativeMethods("DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedNumberList", J.Interceptor);
...
function dart_precompiled($collectedClasses) {
  ...
  function Client_getProduct_closure(completer_0, data_1) {
    this.completer_0 = completer_0;
    this.data_1 = data_1;
  }
  Client_getProduct_closure.builtin$cls = "Client_getProduct_closure";
  if (!"name" in Client_getProduct_closure)
    Client_getProduct_closure.name = "Client_getProduct_closure";
  $desc = $collectedClasses.Client_getProduct_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Client_getProduct_closure.prototype = $desc;
  function Client_getProduct__closure(_prodMedia_2) {
    this._prodMedia_2 = _prodMedia_2;
  }
  Client_getProduct__closure.builtin$cls = "Client_getProduct__closure";
  if (!"name" in Client_getProduct__closure)
    Client_getProduct__closure.name = "Client_getProduct__closure";
  $desc = $collectedClasses.Client_getProduct__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Client_getProduct__closure.prototype = $desc;
  ...
  function ProductItem(_data) {
    this._data = _data;
  }
  ProductItem.builtin$cls = "ProductItem";
  if (!"name" in ProductItem)
    ProductItem.name = "ProductItem";
  $desc = $collectedClasses.ProductItem;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ProductItem.prototype = $desc;
  function ProductMedia(_data) {
    this._data = _data;
  }
  ProductMedia.builtin$cls = "ProductMedia";
  if (!"name" in ProductMedia)
    ProductMedia.name = "ProductMedia";
  $desc = $collectedClasses.ProductMedia;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ProductMedia.prototype = $desc;
  ...
  function main_closure0(client_0, try1_1) {
  ...
  function main_closure1(client_2, try2_3) {
  ...
  function main_closure2(client_4) {
    this.client_4 = client_4;
  }
  ...
  function displayResults_closure() {
  }
  displayResults_closure.builtin$cls = "displayResults_closure";
  if (!"name" in displayResults_closure)
    displayResults_closure.name = "displayResults_closure";
  $desc = $collectedClasses.displayResults_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  displayResults_closure.prototype = $desc;
  ...
  LinkElement.prototype.get$media = function(receiver) {
  ...
  SourceElement.prototype.get$media = function(receiver) {
    return receiver.media;
  };
  ...
  StyleElement.prototype.get$media = function(receiver) {
    return receiver.media;
  };
  ...
  StyleElement0.prototype.get$media = function(receiver) {
    return receiver.media;
  };
