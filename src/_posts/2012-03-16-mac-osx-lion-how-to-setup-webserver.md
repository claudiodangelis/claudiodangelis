...
<ul>
<li>Mac OS X, the operating system;
<li>Apache, the Web server;
<li>MySQL, the database management system (or database server);
<li>P for PHP, Perl, or Python, all programming languages used for web development.
</ul>
</div>
